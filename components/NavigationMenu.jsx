...
export default function NavigationMenu() {
    return (
        <div className='w-full h-auto mb-2 px-[20px] text-[#333333] flex flex-col justify-between items-start lg:px-[100px] lg:flex-row lg:items-center lg:h-[45px] lg:mb-0'>
            ...
            <ul className='w-full flex justify-between flex-wrap gap-x-2 items-center text-[13px] font-normal [&>li]:cursor-pointer lg:w-[665px] lg:justify-between mt-3 lg:flex-nowrap lg:gap-0 lg:m-0'>
                <li>Home</li>
                <li>Shop</li>
                <li>Categories</li>
                <li>Man</li>
